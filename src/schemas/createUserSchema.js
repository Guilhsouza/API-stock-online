...
const registerValidate = joi.object({
    first_name: joi.string().alphanum().required().messages({
    ...
    last_name: joi.string().alphanum().required().messages({
        'string.alphanum': 'O sobrenome não pode ter caracteres especiais.',
